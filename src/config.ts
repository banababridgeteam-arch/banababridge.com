...
export const SITE = {
  ...
  // ---------- 연락처 ----------
  /**
   * TODO: 회사 대표번호 개통 후 입력 (E.164 형식, 예: '+821012345678')
   * 비워두면 사이트 전체의 전화 CTA·JSON-LD telephone이 자동으로 숨겨지고
   * 이메일 문의로 대체됩니다. 번호를 넣는 순간 전부 자동 활성화.
   */
  phone: '',
  /** 화면에 보여줄 번호 표기 (예: '010-1234-5678') */
  phoneDisplay: '',
